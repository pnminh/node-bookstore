...
// We define the variables we will use throughout the tests.
    this.user;
    this.topic;
    this.post;
    this.comment;
...
//define a context for guest users who are not signed in.
...
// #3 test to ensure a user who is not signed in is not able to create a comment.
         describe("POST /topics/:topicId/posts/:postId/comments/create", () => {
           ...
           it("should not create a new comment", (done) => {
             ...
             request.post(options,
               (err, res, body) => {
// #4 comment was not created by querying the database of it.
...
// #5 user who is not signed in is not able to destroy a comment.
