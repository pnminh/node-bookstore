...
// #3
 ...
 //context suites here
/* ---TEST GUEST USER CONTEXT: SHOULD NOT CREATE--------------- */

describe("guest attempting to favorite on a post", () => {

    beforeEach((done) => { // Define a suite to describe a guest user attempting to favorite a post.
      request.get({
...
/* ---SIGNED IN USER CONTEXT: SHOULD CREATE and DESTROY A FAVORITE ---------*/
